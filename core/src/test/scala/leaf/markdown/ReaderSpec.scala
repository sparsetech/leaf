...
class ReaderSpec extends AnyFunSuite {
  test("Bold") {
    assert(
      Reader.parse("**Hello**") == List(
        Node(
          NodeType.Paragraph,
          List(Node(NodeType.Bold, List(Node(NodeType.Text("Hello")))))
        )
      )
    )
  }
  ...
  test("Italic") {
    assert(
      Reader.parse("*Hello*") == List(
        Node(
          NodeType.Paragraph,
          List(Node(NodeType.Italic, List(Node(NodeType.Text("Hello")))))
        )
      )
    )
  }
  ...
  test("Change ID of section") {
    assert(
      Reader.parse("# Title <id value=\"title-2\"/>") == List(
        Node(
          NodeType.Section,
          List(Node(NodeType.Text("Title ")), Node(NodeType.Id("title-2")))
        )
      )
    )
  }
  ...
  test("Code") {
    assert(
      Reader.parse("`code`") == List(
        Node(
          NodeType.Paragraph,
          List(Node(NodeType.Code, List(Node(NodeType.Text("code")))))
        )
      )
    )
    assert(
    ...
    assert(
      Reader.parse("``Ref[_]``") == List(
        Node(
          NodeType.Paragraph,
          List(Node(NodeType.Code, List(Node(NodeType.Text("Ref[_]")))))
        )
      )
    )
  }
  ...
  test("Link") {
    assert(
      Reader.parse("[Google](http://google.com/)") == List(
        Node(
          NodeType.Paragraph,
          List(
            Node(
  ...
  test("Jump") {
    assert(
      Reader.parse("[Section](#section)") == List(
        Node(
          NodeType.Paragraph,
          List(
            Node(
              NodeType.Jump("section"),
              List(Node(NodeType.Text("Section"), List.empty))
            )
          )
        )
      )
  ...
  test("Links or jumps without title") {
    ...
    assert(
      Reader.parse("[http://google.com/]") ==
        List(
          Node(
            NodeType.Paragraph,
            List(Node(NodeType.Text("[http://google.com/]"), List()))
          )
        )
    )

    assert(
      Reader.parse("[#section]") ==
        List(Node(NodeType.Paragraph, List(Node(NodeType.Text("[#section]")))))
    )

    assert(
      Reader.parse("[test]") == List(
        Node(NodeType.Paragraph, List(Node(NodeType.Text("[test]"), List())))
      )
    )
  }
  ...
  test("Convert self-closing HTML tags") {
    assert(
      Reader.parse("""<br/>""") == List(Node(NodeType.Html("br", Map.empty)))
    )
  }

  test("Map supported tag") {
    assert(
      Reader.parse("""<listing result="test"/>""") == List(
  ...
  test("Map supported tag (3)") {
    assert(
      Reader.parse("""<todo>**Hello** World</todo>""") == List(
        Node(
          NodeType.Paragraph,
          List(
            Node(
  ...
  test("Map supported tag (4)") {
    assert(
      Reader.parse("""<todo><b>*Hello* World</b></todo>""") == List(
        Node(
          NodeType.Paragraph,
          List(
            Node(
  ...
  test("Map multiple supported tags") {
    assert(
      Reader.parse(
        s"""<listing result="test"/><listing result="test2"/><listing result="test3"/>"""
      ) == List(
        Node(
          NodeType.Paragraph,
          List(
  ...
  test("Map multiple supported tags (2)") {
    assert(
      Reader.parse(
        s"""  <listing result="test"/>\n  <listing result="test2"/>"""
      ) == List(
        Node(NodeType.Listing(result = Some("test")), List.empty),
        Node(NodeType.Text("\n  "), List.empty),
        Node(NodeType.Listing(result = Some("test2")), List.empty)
  ...
  test("Preserve underscores in code") {
    assert(
      Reader.parse("`Tag[_]`") == List(
        Node(
          NodeType.Paragraph,
          List(Node(NodeType.Code, List(Node(NodeType.Text("Tag[_]")))))
        )
      )
    )
  }
  ...
  test("Do not unescape HTML entities in code") {
    assert(
      Reader.parse("`&apos;`") == List(
        Node(
          NodeType.Paragraph,
          List(Node(NodeType.Code, List(Node(NodeType.Text("&apos;")))))
        )
      )
    )
  }
  ...
  test("Image (1)") {
    assert(
      Reader.parse("![Traits](images/traits.png)") == List(
        Node(
          NodeType.Paragraph,
          List(Node(NodeType.Image("images/traits.png")))
        )
      )
    )
  }
    ...
    assert(
      ...
      """.stripMargin) == List(
        ...
        Node(
          ...
          List(
            Node(
              NodeType.FootnoteBlockItem("first"),
              List(Node(NodeType.Text("First footnote")))
            ),
            Node(
              NodeType.FootnoteBlockItem("second"),
              List(Node(NodeType.Text("Second footnote")))
            )
          )
        )
      )
              ...
              List(
                ...
                Node(
                  ...
                  List(
                    Node(
                      NodeType.ListItem,
                      List(Node(NodeType.Text("Subitem 1")))
                    )
                  )
                )
              )
...
> C""") == List(
  ...
  test("HTML") {
    assert(
      Reader.parse("<p><i>hello</i> world</p>") == List(
        Node(
          NodeType.Html("p", Map.empty),
          List(
            Node(
              NodeType.Html("i", Map.empty),
              List(Node(NodeType.Text("hello")))
            ),
            Node(NodeType.Text(" world"))
          )
        )
  ...
  test("HTML with entity") {
    assert(
      Reader.parse("<p>&auml;</p>") == List(
        Node(NodeType.Html("p", Map.empty), List(Node(NodeType.Text("ä"))))
      )
    )
  }
    ...
    assert(
      Reader.parse(html) == List(
        Node(
          ...
          List(
            Node(
              NodeType.Html("strong", Map.empty),
              List(
  ...
  test("Nested brackets") {
    assert(
      Reader.parse("""[He] [bought [a shirt [with sleeves]]]""") == List(
        Node(
          NodeType.Paragraph,
          List(
  ...
  test("Brackets followed by HTML") {
    assert(
      Reader.parse(
        """I would like to book [for two nights]<tag>Duration</tag>"""
      ) == List(
        Node(
          NodeType.Paragraph,
          List(
            ...
            Node(
              NodeType.Html("tag", Map()),
              List(Node(NodeType.Text("Duration"), List()))
            )
          )
        )
      )
  ...
  test("References in brackets") {
    assert(
      Reader.parse("""morphology [@haspelmath2009, p. 2]""") == List(
        Node(
          NodeType.Paragraph,
          List(
            Node(NodeType.Text("morphology "), List()),
  ...
  test("HTML in brackets") {
    assert(
      Reader.parse("""[Ca<sup>2+</sup>]""") == List(
        Node(
          NodeType.Paragraph,
          List(
            Node(NodeType.Text("[Ca"), List()),
            Node(
              NodeType.Html("sup", Map()),
              List(Node(NodeType.Text("2+"), List()))
            ),
        ...
        List(
          Node(
            ...
            List(
              ...
              Node(
                NodeType.Html("sub", Map()),
                List(
                  Node(
                    NodeType
                      .Html("span", Map("style" -> "font-variant:small-caps")),
                    List(Node(NodeType.Text("b"), List()))
                  )
                )
              )
            )
  ...
  test("List with custom start index") {
    assert(
      Reader.parse(
        ...
        Node(
          NodeType.OrderedList(4),
          List(Node(NodeType.ListItem, List(Node(NodeType.Text("D"), List()))))
        )
      )
    )
  }
